    ...
    return (
        <div>
                ...
                <div className="xl:container mx-auto">
                    <div className="flex flex-col-reverse xl:flex-row xl:gap-32">
                        ...
                        <div className="hidden xl:flex xl:basis-3/4 justify-between">
                            {
                                Object.keys(FooterContent).map((item, index) => (
                                    <div key={index}>
                                        <h4 className='text-md font-bold uppercase leading-8 mb-3'
                        ...
                        <div className='px-4 xl:px-0 xl:basis-1/4'>
                            <h4 className='basis-1/4 text-md font-bold capitalize xl:uppercase leading-8 mb-0 xl:mb-3'>
            ...
            <div className='bg-primaryBackground'>
                <p className='text-sm xl:text-sm leading-10 xl:leading-[76px] text-center text-accentGray'>© 2024 wohuoptical.com. All rights
                    reserved</p>
            </div>
        </div>
    );
